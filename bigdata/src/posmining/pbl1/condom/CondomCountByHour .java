...
/**
 * 時間帯別のコンドームの個数を出力する: add comments
 * @author thuy
 *
 */
public class CondomCountByHour {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
		...
		job.setJarByClass(CondomCountByHour.class);       // ★このファイルのメインクラスの名前
		...
		String outputpath = "out/condomCountByHour";     // ★MRの出力先
		if (args.length > 0) {
			inputpath = args[0];
		}
